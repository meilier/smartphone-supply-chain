...
type MaterilaInfo struct {
	...
	Power_Dissipation				string `json:Power_Dissipation`
...
func (t *MaterialChaincode) record(stub shim.ChaincodeStubInterface, args []string) pb.Response {
	...
	var record = MaterilaInfo{Type: args[1],Bandwidth:args[2], Power_Dissipation:args[3],Performance:args[4], Purchaser: args[5]}
