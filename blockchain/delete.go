...
func (setup *FabricSetup) DeleteCC(channelName, chainCode, fcn string, key []byte) (string, error) {
	...
	response, err := client.Execute(channel.Request{ChaincodeID: chainCode, Fcn: fcn, Args: queryArgs})
	fmt.Println(err)
	if err != nil {
